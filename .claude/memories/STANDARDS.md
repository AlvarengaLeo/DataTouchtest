...
```css
/* ✅ CORRECTO: Usar CSS vars con fallback */
color: var(--dt-text-primary, #FFFFFF);
background: var(--dt-surface-card, rgba(255,255,255,0.05));

/* ❌ INCORRECTO: Hex hardcodeado en componentes synced */
color: #FFFFFF;
background: #1a1a2e;

/* ❌ INCORRECTO: Inline tokens en Blazor */
style="color: @_themeTokens.TextPrimary"
```

### Shared Components (Sync Contract)

```razor
@* ✅ CORRECTO: Componente compartido con Compact *@
<SocialLinksRow Compact="true" LinkedIn="@_linkedin" />

@* ❌ INCORRECTO: Markup inline diferente por superficie *@
<div class="my-custom-social-icons">...</div>
```
